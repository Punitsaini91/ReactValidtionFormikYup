...
export const validationSchema = yup.object().shape({
  ...
  .test(
    ...
    (value) => {
      ...
      return /^[A-Za-z0-9]/.test(localPart); // Checking if the first character is a special character
    }
  )
  .test(
    'local-part-length',
  ...
  .max(16, 'Password not exceed  16 characters'),
...
confirmPassword: string()
  ...
  .min(0.01, 'Please enter a positive decimal number'), // Set a minimum value excluding single positive numbers
// ... other fields
