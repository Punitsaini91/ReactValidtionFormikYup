...
export const Form = () => {
  ...
  const handleReset = (resetForm) => {
    resetForm();
    const newCaptcha = generateCaptcha(); // Generate a new CAPTCHA on reset
    setCaptcha(newCaptcha); // Update the captcha value in the state
    setFieldValue("captcha", newCaptcha);
  };
